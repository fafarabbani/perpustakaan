<x-app-layout>
    <x-slot name="header">
        <div class="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            ...
            <x-button target="_blank" href="https://github.com/kamona-wd/perpustakaan" variant="black"
    ...
    <div class="flex items-center gap-5 pb-5">
        ...
        <div class="md:w-1/4 p-6 overflow-hidden bg-orange-50 rounded-md shadow-md dark:bg-dark-eval-1">
            <a href="" class="flex items-center justify-between gap-3">
                <div class="flex flex-col justify-between p-1 leading-normal">
                    <p class="mb-1 font-medium text-sm text-gray-700 dark:text-gray-400">
                        {{ __('Total Pengembalian') }}
                    </p>
                    <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                        {{ $data['jmlPengembalian'] }}
                    </h5>
                </div>
                <div>
                    <svg xmlns="http://www.w3.org/2000/svg" height="32" width="40" viewBox="0 0 640 512">
    ...
    <div class="p-6 overflow-hidden bg-white rounded-md shadow-md dark:bg-dark-eval-1">
        <h2 class="text-xl font-semibold leading-tight pb-5">
            {{ __('Grafik Peminjaman & Pengembalian per Minggu') }} ({{ now()->format('F Y') }})
        </h2>
        <canvas id="grafikPeminjaman" width="400" height="100"></canvas>
    </div>
</x-app-layout>
